...
from app.schemas.user_skills import (BaseResponseSchema,
                                     UserSkillDetailResponse,
                                     UserSkillListResponse, UserSkillSchema)
...
@router.get("/")
async def get_user_skills(service: UserSkillService = Depends(UserSkillService), user_data:UserTokenDecodedData=Depends(CommonService.verify_token_get_user)) -> UserSkillListResponse:
...
async def create_user_skill(
    user_skill: UserSkillSchema, service: UserSkillService = Depends(UserSkillService), user_data:UserTokenDecodedData=Depends(CommonService.verify_token_get_user)
) -> BaseResponseSchema:
