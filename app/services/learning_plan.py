...
from app.schemas.learning_plan import (LearningPlanDetailResponse,
...
class LearningPlanService:
    ...
    async def create_learning_plan(self, learning_plan: LearningPlanSchema)->BaseResponseSchema:
        await self.repository.create_learning_plan(learning_plan)
    ...
    async def get_learning_plans(self, user_id: str) -> LearningPlanListResponse:
        ...
        return {'data': data, 'message': 'Learning plans fetched successfully', 'success': True}
    
    async def get_learning_plan_by_id(self, learning_plan_id: str) -> LearningPlanDetailResponse:
        data = await self.repository.get_learning_plan_by_id(learning_plan_id)
        return {'data': data, 'message': 'Learning plan fetched successfully', 'success': True}
    
    async def update_learning_plan(self, learning_plan_id: str, learning_plan: LearningPlanSchema)->BaseResponseSchema:
