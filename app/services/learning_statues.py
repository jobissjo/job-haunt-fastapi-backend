...
from app.schemas.learning_status import (
    BaseResponseSchema,
...
class LearningStatusService:
    ...
    async def create_learning_status(
        ...
        await self.repository.create_learning_status(learning_status, user_id)
    ...
    async def get_learning_statuses(self, user_id: str) -> LearningStatusListResponse:
        ...
        return {
            "data": data,
            "message": "Learning statuses fetched successfully",
            "success": True,
        }
    ...
    async def get_learning_status_by_id(
        ...
        return {
            "data": data,
            "message": "Learning status fetched successfully",
            "success": True,
        }
    ...
    async def update_learning_status(
        ...
        await self.repository.update_learning_status(
            learning_status_id, learning_status
        )
