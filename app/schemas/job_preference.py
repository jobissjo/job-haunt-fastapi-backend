...
class JobPreferenceBase(BaseModel):
    ...
    preferred_locations: Optional[List[str]] = Field(default_factory=list, example=["Chennai", "Bangalore"])
    employment_type: Optional[str] = Field(None, example="Full-time")  # Full-time / Part-time / Remote
